...
class MatchingModel(models.Model):
    ...
    matching_algorithm = models.PositiveIntegerField(
        ...
        default=MATCH_ANY,
        help_text=(
            "Який алгоритм ви хочете використовувати при зіставленні тексту з OCR-файлом PDF. "
            "Так, \"any\" шукає будь-яке входження будь-якого слова, вказаного в PDF, тоді як \"all\" "
            "потребує, щоб кожне задане слово відображалося в PDF, хоча і не в заданому порядку."
            "\"Literal\" збіг означає, що текст, який ви вводите, повинен бути відображений в PDF точно так, "
            "як ви його ввели, і \"Regular Expression\" використовує регулярний вираз для відповідності PDF. "
            "(Якщо ви не знаєте, що таке регулярний вираз, ви ймовірно, не хочете цього варіанту.) Нарешті, "
            "\"Fuzzy Match\" шукає слова або фрази, які здебільшого - але не зовсім - однакові, що може бути "
            "корисним для порівняння з документами, що містять недоліки, що перешкоджають точному OCR."
        )
    )
